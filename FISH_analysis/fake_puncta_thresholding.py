# -*- coding: utf-8 -*-
"""
Created on Thu Dec  2 09:02:48 2021

@author: kayla

fake_puncta_thresholding because Kayla's computer has trouble recognizing
    file path names
"""
...
class Puncta_Thresholding:
    ...
    def plot_image(self, image, title = ''):
        ...
        plt.title(title)
        plt.axis('off')
        plt.savefig(('C:/Users/kayla/project/FISH-Image-Analysis/thresholding_output/'.strip() + str(title).strip().lower() + '.png'.strip()))
    ...
    def watershed(self, output = "plot"):
        ...
        if output == "plot":
            ...
            cv2.imwrite("C:/Users/kayla/project/FISH-Image-Analysis/thresholding_output/watershed.png", masked)
    ...
    def gaussian_blur(self, kernel_size, output = "plot"):
        ...
        if output == "plot":
            cv2.imwrite("C:/Users/kayla/project/FISH-Image-Analysis/thresholding_output/gaussian_blur.png", dst)
        else:
    ...
    def binary_threshold(self, threshold, output = "plot"):
        ...
        if output == "plot":
            ...
            cv2.waitKey(0)
            cv2.destroyAllWindows()
            cv2.imwrite("C:/Users/kayla/project/FISH-Image-Analysis/thresholding_output/binary_threshold.png", masked)
    ...
    def erosion(self, iterations, output = "plot"):
        ...
        if output == "plot":
            ...
            cv2.imwrite("C:/Users/kayla/project/FISH-Image-Analysis/thresholding_output/erosion.png", img_erosion)
            cv2.waitKey(0)
    ...
    def get_centroids(self, threshold):
        ...
        #display the image
        cv2.imwrite('C:/Users/kayla/project/FISH-Image-Analysis/thresholding_output/centroids.png', mask)
        cv2.waitKey(0)
